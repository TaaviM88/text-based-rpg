...
namespace TextRPG
{
    public class Encouter : MonoBehaviour {
        ...
        public void Attack()
        {
            ...
            Journal.Instance.Log("<color=#59ffa1>You attacked, dealin <b>"+ playerDamageAmount + "</b> damage!</color>");
        ...
        public void ExitFloor()
        {
            ...
            player.NewFloorStartingpPoint();
            player.Floor += 1;
            Journal.Instance.Log("You have found an exit to another floor. Floor: " + player.Floor);
